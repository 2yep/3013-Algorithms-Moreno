...
*    Description:
*
*       A trie tree variation of the linked list based search program that stores a file 
*       with wordsin it. Then allowes the user to type in a series of character. Everytime 
*       a user enters a character the program will search through the list to find all the words
...
{
    Trie *T = new Trie();
    vector<string> words;      // Placeholder animals_Data to read in the words.txt data
